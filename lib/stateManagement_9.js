		...
		function crossfilter(params_chart, params_chart_target, filter_array, ind_filtering_type) {
			...
			if (params_chart_target.chart_type === 'chartJS' || params_chart_target.chart_type === 'leaflet') {
				if (params_chart_target.list_labels_segment_single_selected.length !== 0 || params_chart_target.list_labels_segments_multiples_selected.length !== 0 
					...
					params_chart_target.instanciator.prepare_data_p2(dataset_filtred, params_chart_target)
					...
					params_chart_target.chart_type === "chartJS" ? hide_legends(params_chart_target, 'set_filter') : params_chart_target.instanciator.setup_legends(params_chart_target, 'update')
