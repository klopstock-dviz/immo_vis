		...
		*/			
			...
			if (Object.keys(params_pieChart.backgroundColorArray_source).length === 0) {
        		...
        		if (sharedParams.used_color_schemes.hasOwnProperty(colored_axis) === true) {
	        		var backgroundColorArray_source = generateColors(nb_categories, sharedParams.used_color_schemes[colored_axis], params_pieChart.colorsConfig.colorsOrder, colored_axis, sharedParams)
					categories.map(axis => {
	        		...
	        		var backgroundColorArray_source = generateColors(nb_categories, params_pieChart.colorsConfig.scheme, params_pieChart.colorsConfig.colorsOrder, colored_axis, sharedParams)
					categories.map(axis => {
						params_pieChart.backgroundColorArray_source[axis] = select_generated_color(backgroundColorArray_source, i); 
						i++
						} )
