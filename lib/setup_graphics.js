...
instantiateur_map1.createChart(params_map1) //here you can pass a dataset as 2nd parameter, this will override the main dataset of the sharedParams
    ...
    instantiateur_labelGroup1.createChart(params_labelGroup1)
    ...
    instantiateur_labelGroup2.createChart(params_labelGroup2)
    ...
    instantiateur_labelGroup3.createChart(params_labelGroup3)
...
function updateCharts(sharedParams) {
